...
const resources: Resource[] = [
  ...
  {
    display: "Student Legal Services",
...
export default function ResourcesPage() {
  ...
  return (
    <Prose>
      ...
      <p>
        We are more than happy to chat for any reason, but the expertise of
        members of the AATU comes from our organizing with our neighbors to
        form local tenant associations and win citywide legislative change.
        For other questions, and especially to get in contact with a lawyer,
        ...
        <section className={styles.resourceSection} key={key}>
          ...
          <div className={styles.resourceList}>
            {resources.map((resource) => (
              <div key={resource.href} className={styles.resource}>
