    ...
    <div className={classes.container}>
      <div className={classes.content}>
        ...
        <p>
          ...
          hopefully identify paths for you within AATU that are right
          for you. But generally, we recommend a few options, most
          valuable being listed first:
        </p>
        <ul>
          <li>
            <p>
        ...
        <p>
          ...
          AATU members vote on major decisions of the union. More
